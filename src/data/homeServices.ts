...
export const SERVICES: ServiceEntry[] = [
  {
    ...
    title: 'מערכת JARVIS',
    blurb:
      'עוזר AI אוטונומי בעברית מלאה שמתחבר למיילים, ליומן ול-CRM ומריץ תהליכים מקצה לקצה — בפקודה קולית או בטקסט.',
    points: ['פעולות אמת מול מערכות קיימות', 'זיכרון הקשר ולמידת דפוסי עבודה', 'הרשאות, לוגים ובקרת גישה מלאה'],
    to: '/jarvis',
    flagship: true,
    badge: 'מערכת דגל',
  ...
  },
  {
    ...
    points: ['אינטגרציה למקורות הנתונים שלכם', 'Human-in-the-loop בנקודות הכרעה', 'מדידת ROI לכל תהליך'],
    to: '/ai',
    flagship: true,
    badge: 'הכי מבוקש',
    span: 'lg:col-span-3',
  },
  {
    ...
    blurb:
      'ספק אחד אחראי על כל הסטאק — פיתוח, ענן, אבטחת סייבר ואינטגרציות — במקום לתאם בין חמישה גורמים.',
  ...
  },
  {
    ...
    blurb: 'קוד שנכתב עבורכם, לא תבנית מהמדף — נטען מהר, עובד בכל מכשיר, בנוי להמרות ולתחזוקה קלה.',
    to: '/digital',
    span: 'lg:col-span-2',
  },
  {
    ...
    blurb: 'מסכים שברור בהם מה לעשות — עיצוב שמוביל את המשתמש צעד-צעד אל הפעולה, פחות נטישה ויותר פניות.',
    to: '/digital',
    span: 'lg:col-span-2',
  },
  {
    ...
    blurb: 'מקור אמת אחד, דוחות מיידיים והחלטות מהירות — במקום בלגן של עשרות גיליונות אקסל.',
    to: '/architecture',
    span: 'lg:col-span-2',
  },
  {
    ...
    blurb:
      'משימות חוזרות שקורות לבד — תזכורות, סנכרונים, עדכוני סטטוס. פחות עבודה ידנית, פחות טעויות, וצוות שמתפנה למה שחשוב.',
    to: '/ai',
    span: 'lg:col-span-6',
  },
];
