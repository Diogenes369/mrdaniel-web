...
export const HOME_OFFERS: HomeOffer[] = [
  ...
  },
  {
    ...
    intro:
      'הגנה בגישת Zero-Trust שנבנית מראש, לא אחרי הפריצה. מיפוי חשיפות, הקשחה וניטור איומים רציף — על התשתית, על הענן ועל מודלי ה-AI שלכם. אותה רמת הגנה, בין אם אתם עסק של חמישה או ארגון של אלף.',
    bullets: [
      ...
      { icon: Building2, title: 'בקנה מידה שלכם', body: 'אותה רמת הגנה, בהיקף ובתקציב שמתאימים ל-SMB או לאנטרפרייז.' },
    ],
    route: '/cyber',
