...
export default function MotionPreviewSection() {
  ...
  return (
    <section className="relative z-10 py-24 border-y border-white/10 bg-carbon-900/60 backdrop-blur-sm">
      <div className="container mx-auto px-6 max-w-3xl text-center">
        ...
        <p className="text-zinc-300 leading-relaxed mb-8">
          הרקע שמאחורי הדף — הגלובוס המחוברר בחלקיקים בראש הדף, שכבת ה-Aurora, והסמן המותאם — כולם
          רצים על מנוע <span className="text-white font-medium">Canvas2D</span> קליל, ללא Three.js
          וללא ספריית אנימציה. גררו את הגלובוס בראש הדף, הזיזו את העכבר קרוב אליו, וגללו למעלה
          ולמטה כדי לראות את הכותרת הזו נכנסת ויוצאת דרך המסכה שלה.
        </p>
