...
export interface SecurityCheckResult {
  ...
  flags: string[];
  /** The badge string to display next to a passed item, e.g. "AI Guard Verified 🛡️". */
  badge: string;
}
...
export interface GeneratedContentItem {
   ...
   * platform/format. Never abstract 3D/digital-brain/cartoonish "AI art"; always real
   * AI-workspace photography (GPU servers, developer workstations, research labs) matched to the item's
