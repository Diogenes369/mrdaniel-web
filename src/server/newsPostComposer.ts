...
const WHY_IT_MATTERS: Record<NewsTopic, string> = {
  ...
  devops:
    'מעבר לכותרת: DevOps אמיתי הוא לא כלי, הוא איך צוותי פיתוח ותשתיות עובדים ביחד — פייפליין CI/CD שרץ אוטומטית, תשתית-כקוד שגרסאתית ובת-שחזור, וניטור שמתריע לפני שהלקוח מרגיש. הפער בין ארגון "עם DevOps" לבין ארגון שרק מריץ סקריפטים הוא משמעת: בדיקות אוטומטיות בכל דיפלוי, Rollback מוגדר מראש, ותרבות של תיעוד ותחקור תקלות (Postmortem) בלי חיפוש אשמים.',
  general:
