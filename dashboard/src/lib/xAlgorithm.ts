/**
 * DASHBOARD MIRROR of src/server/xAlgorithm.ts — the offline scorer/thread builder used when Grok
 * is unavailable. Keep the two in sync (the server copy is the source of truth).
 *
