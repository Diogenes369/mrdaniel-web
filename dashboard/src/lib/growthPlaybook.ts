...
export const CORE_IL_TAGS = ['#בינהמלאכותית', '#סוכניAI', '#מודליAI', '#אוטומציה'];
...
const TOPIC_KEYWORD: Record<NewsTopic, string> = { ai: 'סוכן', ai_models: 'מודל', ai_agents: 'סוכן', general: 'מדריך' };
...
const CLICHE = /בעולם של היום|בעידן ה|היום נדבר|שלום לכולם|היי חברים|חדשות טובות|עדכון חדש|כתבה חדשה|מעניין לדעת|בואו נדבר|בואו נצלול|חשוב לציין|חשוב לזכור|מהפכני|פורצ?ת? דרך|לסיכום|הנה כמה דרכים|ללא ספק|כללי המשחק/;
